...
k = 35  # lower rank
Lambda = 20  # regularization parameter (the same for U and V)
...
def read_file(filename):
	...
	return R.tocsr()
R_train = read_file('data/ml-100k/u2.base')
R_test = read_file('data/ml-100k/u2.test')
...
softImpute_alg.Ssimpute_ALS(R_train, U, V, Dsq, k, 1e-05, Lambda, 100)
print('RMSE on test data:', softImpute_alg.compute_rmse_UV(R_test, U, V, Dsq))
print('')
